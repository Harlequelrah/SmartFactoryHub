"""
Django settings for SmartFactoryHub project.
...
SECRET_KEY = 'django-insecure-4!m74=ok7e91&1l1-@yt-=+t$lwr1!#-!^_=z+7^p)@bydo&uq'
...
ROOT_URLCONF = 'SmartFactoryHub.urls'
